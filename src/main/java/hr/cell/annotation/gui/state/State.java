package hr.cell.annotation.gui.state;
...
public interface State {
	...
	// Poziva se nakon što je platno nacrtalo grafički objekt predan kao
	// argument
	void afterDraw(Graphics2D r, GraphicalObject go);

	// Poziva se nakon što je platno nacrtalo čitav crtež
	void afterDraw(Graphics2D r);
